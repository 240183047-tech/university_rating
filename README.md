...
## Team: On Jeti
Zhanar Muratova:  Web Scraping Architecture, Report & Presentation.
...
##  Usage
The entire project lifecycle from data processing and cleaning to statistical analysis and machine learning is contained within a single, self-documented Jupyter Notebook. Run onjeti_code.ipynb in google colab to see. Start directly from cleaning step to download dataset from kaggle. If you want to scrape on your own, check that for loop is numbered correctly, if not, set to (1, 114). Make sure to pre-install everything from requirements txt.
